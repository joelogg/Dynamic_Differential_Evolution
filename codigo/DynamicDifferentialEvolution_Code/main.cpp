...
typedef CDynamicalDifferentialEvolution<pattern_t,10,fitness_t> evolution_t;
*/
...
double  max_value = 500;
double  min_value = -500;
typedef CPattern<double, 8,0> pattern_t;
typedef FitnessSchwefel<pattern_t> fitness_t;
...
typedef CPattern<double,8,100> pattern_t;
...
int main (int, char*[]){
	...
	while (nRep-- > 0)
	{
		...
		evolution_t _p(min_value, max_value, .01, .4, 50); // for Schwefel d8
